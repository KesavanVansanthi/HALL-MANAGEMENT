...
public class HallOwnerDetails implements UserDetails{
	HallOwnerDetailsDatabase ownerdata = new HallOwnerDetailsDatabase();
	private String userName;
	private String Password;
	
	public HallOwnerDetails(){
	...
	public void showDetails() {
		...
		try {
			ownerdata.view(this.getUserName(),this.getPassword());
				...
				case 1:
					do {
						...
						if(!userNameMatcher.matches()){
							...
							val='n';
							ownerdata.dataUpdate(this.getUserName(),this.getPassword(),1,newName);
						}
				...
				case 2:
					do {
						...
						if(!Pattern.matches("^[a-zA-Z]+$",firstName)) {
							...
							val='n';
							ownerdata.dataUpdate(this.getUserName(),this.getPassword(),2,firstName);
				...
				case 3:
					do {
						...
						if(!Pattern.matches("^[a-zA-Z]+$",lastName)) {
							...
							val='n';
							ownerdata.dataUpdate(this.getUserName(),this.getPassword(),3,lastName);
							System.out.print(Colors.YELLOW+"\n          Do you want to Update AGAIN ?(y/n) : "+Colors.RESET);
							try {
								value=sc.readLine().charAt(0);
							}catch(Exception e) {
					...
					do {
						...
						try {
							String Age= sc.readLine();
							 System.out.println("            -----------------------------------------------");
							 val='n';
								ownerdata.dataUpdate(this.getUserName(),this.getPassword(),4,Age);
								System.out.print(Colors.YELLOW+"\n          Do you want to Update AGAIN ?(y/n) : "+Colors.RESET);
								try {
									value=sc.readLine().charAt(0);
								}catch(Exception e) {
...
//						System.out.println(dateOfBirth);
						...
						ownerdata.dataUpdate(this.getUserName(),this.getPassword(),5,dob);
						System.out.print(Colors.YELLOW+"\n          Do you want to Update AGAIN ?(y/n) : "+Colors.RESET);
						try {
							value=sc.readLine().charAt(0);
						}catch(Exception e) {
				...
				case 6:
					do {
						...
						if(!Pattern.matches("^[a-zA-Z]+$",city)) {
							...
							val='n';
							ownerdata.dataUpdate(this.getUserName(),this.getPassword(),6,city);
							System.out.print(Colors.YELLOW+"\n          Do you want to Update AGAIN ?(y/n) : "+Colors.RESET);
							try {
								value=sc.readLine().charAt(0);
							}catch(Exception e) {
				...
				case 7:
					do {
						...
						if(!Pattern.matches("^[6-9][0-9]{9}$",phoneNo)) {
							...
							val='n';
							ownerdata.dataUpdate(this.getUserName(),this.getPassword(),7,phoneNo);
							System.out.print(Colors.YELLOW+"\n          Do you want to Update AGAIN ?(y/n) : "+Colors.RESET);
							try {
								value=sc.readLine().charAt(0);
							}catch(Exception e) {
				...
				case 8:
					do {
						...
						if(!emailMatcher.matches()){
							...
							val='n';
							ownerdata.dataUpdate(this.getUserName(),this.getPassword(),8,mail);
						}
						System.out.print(Colors.YELLOW+"\n          Do you want to Update AGAIN ?(y/n) : "+Colors.RESET);
						try {
							value=sc.readLine().charAt(0);
								...
								if(!passwordMatcher.matches()){
									...
									do {
										...
										if(!confirmpass.equals(this.getPassword())) {
											...
											ownerdata.dataUpdate(this.getUserName(),this.getPassword(),9,newPass);
											System.out.print(Colors.YELLOW+"\n          Do you want to Update AGAIN ?(y/n) : "+Colors.RESET);
											try {
												value=sc.readLine().charAt(0);
											}catch(Exception e) {
